...
> $\frac{\color{Orange}\partial C_0 }{\color{cyan}\partial w^{(L)}}=\frac{\color{Teal}\partial z^{(L)}}{\color{cyan}\partial w^{(L)}}·\frac{\partial a^{(L)}}{\color{Teal}\partial z^{(L)}}=\frac{\color{Orange}\partial C_0}{\partial a^{(L)}}$
